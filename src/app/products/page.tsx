...
import { productCategories, productPartners, productStats } from '@/data/productsData'
            ...
            <section className="products-hero">
                <div className="container products-hero__inner">
                    <div className="products-hero__content">
                        ...
                        <h1 className="products-hero__title">Industry-Leading Global Data Solutions</h1>
                        <p className="products-hero__sub">
                            From flagging the risk of fraud to validating if an address is deliverable by the USPS,
                            our solutions start by ensuring your global contact data is genuine, accurate and up-to-date.
                        </p>
            ...
            <section className="products section">
                <div className="container">
                    <div className="section-header--center">
                        <h2 className="section__title">Our Global Data Validation Services</h2>
                        <p className="section__sub">
                            We focus exclusively on global contact and customer data verification while constantly evolving
                            to meet our customers&apos; needs and support new technologies.
                        </p>
                    </div>
                        ...
                        {productStats.map((stat) => (
                            <article key={stat.label} className="products-stats__card">
                                <div className="products-stats__icon">
                                    <Image
                                        src="/images/products/stat-icon-placeholder.png"
                                        alt=""
                                        width={28}
                                        height={28}
                                        aria-hidden="true"
                    ...
                    <div className="products-grid">
                        {productCategories.map((category) => (
                            <article key={category.id} id={category.id} className="products-card">
                                <h3 className="products-card__title">{category.title}</h3>
                                <p className="products-card__desc">{category.description}</p>
                    ...
                    <div className="products-partners">
                        ...
                        <div className="products-partners__logos">
                            {productPartners.map((partner) => (
                                <Image key={partner.alt} src={partner.src} alt={partner.alt} width={110} height={44} />
                            ))}
                        </div>
                    </div>
                </div>
