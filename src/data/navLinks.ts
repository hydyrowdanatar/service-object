...
export const navLinks: NavItem[] = [
    ...
    },
    {
        ...
        children: [
            {
                label: 'Fixing Bad Addresses',
                href: '/solutions/fixing-bad-addresses/',
                description: 'Detect and correct invalid and bad addresses'
            },
            {
                label: 'Achieving Compliance',
                href: '/solutions/achieving-compliance/',
                description: 'Support compliance with accurate customer data'
            },
            {
                label: 'Managing Fraud',
                href: '/solutions/managing-fraud/',
                description: 'Flag & remove low quality and fraudulent accounts'
            },
            {
                label: 'Leveraging Business Intelligence',
            ...
            },
            {
                ...
                description: 'Optimize operations and boost productivity'
            },
            {
                label: 'Understanding Customer Data Validation',
                href: '/solutions/customer-data-validation/',
                description: 'Learn how Customer Data Validation works'
            },
        ],
    },
    {
        ...
        children: [
            {
                ...
                href: '/docs/',
                description: 'Comprehensive guides for integration and implementation'
            },
            {
                label: 'Sample Code',
                href: '/developers/sample-code/',
                description: 'Sample code & code libraries for major programming languages'
            },
            {label: 'Sample Data', href: '/sample-data/', description: 'Accelerate testing with sample data'},
            {
                label: 'Quick Lookups',
                href: '/developers/lookups/',
                description: 'Use your API key to validate a small set of records'
            },
            {
                label: 'Integrations',
                href: '/blog/integrations/',
                description: 'Testing tools, example integrations and mashups'
            },
            {label: 'Upload Your List', href: '/upload-center/', description: 'Send us your list to validate'},
            {
                label: 'DataTumbler App',
                href: '/developers/datatumbler/',
                description: 'Desktop application for DIY data cleansing'
            },
            {
                label: 'NuGet Packages',
                href: '/developers/nuget/',
                description: 'Expedite integration with NuGet packages'
            },
        ],
    },
    {
        ...
        children: [
            {
                ...
                href: '/support/tech-support/',
                description: 'Contact us for customer and technical support'
            },
            {
                label: 'Usage Reports',
                href: '/support/usage-reports/',
                description: 'Check transaction usage on your trial and production keys'
            },
            {
                label: 'Failover Configuration',
                href: '/support/failover-configuration/',
                description: 'Overview of our data centers and failover protocol'
            },
            {
                label: 'Performance Reports',
                href: '/support/performance-reports/',
                description: 'Response and Uptime reports (2006 to present)'
            },
            {
                label: 'Professional Services',
                href: '/support/professional-services/',
                description: 'Developer support for integrations and customizations'
            },
            {
                label: 'Security',
                href: '/support/security/',
                description: 'Overview of our bank-grade security and privacy measures'
            },
            {
                label: 'Service Level Agreement',
                href: '/support/service-level-agreement/',
                description: 'Our service level commitment'
            },
            {
                label: 'Master Service Agreement',
                href: '/support/master-service-agreement/',
                description: 'The agreement that governs our service offerings'
            },
        ],
    },
    {
