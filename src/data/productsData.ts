...
export const productStats = [
  {
    ...
    src: "/images/products/stats/customer.png",
  },
  {
    value: "99.999%",
    label: "Uptime Guarantee",
    src: "/images/products/stats/guarantee.png",
  },
  {
    value: "Dedicated",
    label: "Support Engineers",
    src: "/images/products/stats/support.png",
  },
];
...
export const productCategories: ProductCategory[] = [
  {
    ...
    items: [
      ...
      {
        label: "Address Validation - Canada",
        href: "/address-validation-canada/",
      },
      {
        label: "Address Validation - International",
        href: "/address-validation-international/",
      },
    ...
    src: "/images/products/categories/address.jpg",
  },
  {
    id: "lead",
    title: "Lead",
    ...
    items: [
      ...
      {
        label: "Lead Validation - International",
        href: "/lead-validation-international/",
      },
    ],
    src: "/images/products/categories/lead.jpg",
  },
  {
    id: "name",
    title: "Name",
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Phone Validation - International",
        href: "/phone-validation-international/",
      },
    ],
    src: "/images/products/categories/phone.jpg",
  },
  {
    id: "email",
    title: "Email",
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Address Geocode - International",
        href: "/address-geocode-international/",
      },
    ],
    src: "/images/products/categories/geocoding.png",
  },
  {
    id: "ecommerce",
    title: "Ecommerce",
    ...
    src: "/images/products/categories/ecommerce.jpg",
  },
];
